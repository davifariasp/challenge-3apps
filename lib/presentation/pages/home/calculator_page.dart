        ...
        child: Column(
          children: [
            ...
            DropdownButton<Gender>(
              ...
              items: Gender.values.map((Gender gender) {
                return DropdownMenuItem<Gender>(
                    value: gender, child: Text(gender.displayName));
              }).toList(),
            ...
            DropdownButton<ActivityLevel>(
              ...
              items: ActivityLevel.values.map((ActivityLevel activityLevel) {
            ...
            TextButton(
                onPressed: calculateCalories, child: const Text('Calcular')),
            Text(tmb.toStringAsPrecision(6))
          ],
        ),
      ),
    );
